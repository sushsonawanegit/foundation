...
with ax_opco_pymnt_mode as(
    ...
    from FIVETRAN.AX_PRODREPLICATION1_DBO.CUSTPAYMMODETABLE
...
select * from final
        ...
        where stg_load_dtm > (select max(stg_load_dtm) from OI_DATA_DEV_V2.intermediate_fnd_bkp.ax_opco_pymnt_mode ) 
