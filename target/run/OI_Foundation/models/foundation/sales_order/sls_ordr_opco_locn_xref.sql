      ...
      create or replace  table OI_DATA_DEV_V2.FND_DEV_BKP.sls_ordr_opco_locn_xref  as
      (with sls_ordr_opco_locn_xref as(
    select *,
    ...
    from OI_DATA_DEV_V2.intermediate_fnd_bkp.v_sls_ordr_opco_locn_xref_lineage
),
final as(
    select 
