      ...
      create or replace  table OI_DATA_DEV_V2.FND_DEV_BKP.opco_item_opco_assctn_xref  as
    ...
    from OI_DATA_DEV_V2.intermediate_fnd_bkp.v_opco_item_opco_assctn_xref_lineage
),
final as(
    select 
