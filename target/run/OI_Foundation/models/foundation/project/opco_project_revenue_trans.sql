      ...
      create or replace  table OI_DATA_DEV_V2.FND_DEV_BKP.opco_project_revenue_trans  as
    ...
    from OI_DATA_DEV_V2.intermediate_fnd_bkp.v_opco_project_revenue_trans_lineage
),
final as(
    select 
