      ...
      create or replace  table OI_DATA_DEV_V2.FND_DEV_BKP.opco_vendor_packing_slip_line  as
    ...
    from OI_DATA_DEV_V2.intermediate_fnd_bkp.v_opco_vendor_packing_slip_line_lineage
),
final as(
    select 
