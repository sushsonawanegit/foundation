      ...
      create or replace  table OI_DATA_DEV_V2.FND_DEV_BKP.opco_cust_opco_locn_xref  as
      (with opco_cust_opco_locn_xref as(
    select *,
    ...
    from OI_DATA_DEV_V2.intermediate_fnd_bkp.v_opco_cust_opco_locn_xref_lineage
),
final as(
    select 
