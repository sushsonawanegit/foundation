  ...
  create or replace  view OI_DATA_DEV_V2.intermediate_fnd_bkp.v_opco_cust_opco_locn_xref_lineage 
  
   as (
    with v_opco_cust_opco_locn_xref_lineage as(
        ...
        (
            select
                    ...
                    cast("OPCO_CUST_OPCO_LOCN_XREF_CK" as character varying(32)) as "OPCO_CUST_OPCO_LOCN_XREF_CK" ,
                    cast("OPCO_CUST_SK" as character varying(32)) as "OPCO_CUST_SK" ,
                    cast("OPCO_LOCN_SK" as character varying(32)) as "OPCO_LOCN_SK" ,
                    cast("OPCO_CUST_OPCO_LOCN_ASSCN_TYPE_TXT" as character varying(4)) as "OPCO_CUST_OPCO_LOCN_ASSCN_TYPE_TXT" ,
                    cast("CRT_DTM" as TIMESTAMP_LTZ) as "CRT_DTM" ,
                    cast("STG_LOAD_DTM" as TIMESTAMP_TZ) as "STG_LOAD_DTM" ,
                    cast("DELETE_DTM" as TIMESTAMP_TZ) as "DELETE_DTM" ,
                    cast("SRC_SYS_NM" as character varying(2)) as "SRC_SYS_NM" ,
                    cast("CONTACT_TYPE_TXT" as character varying(40)) as "CONTACT_TYPE_TXT" ,
...
select * from v_opco_cust_opco_locn_xref_lineage
  );
