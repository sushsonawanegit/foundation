  ...
  create or replace  view OI_DATA_DEV_V2.intermediate_fnd_bkp.v_opco_vendor_opco_locn_xref_lineage 
    ...
    with v_opco_vendor_opco_locn_xref_lineage as(
        ...
        (
            select
                    ...
                    cast("OPCO_VENDOR_OPCO_LOCN_XREF_CK" as character varying(32)) as "OPCO_VENDOR_OPCO_LOCN_XREF_CK" ,
                    cast("OPCO_VENDOR_SK" as character varying(32)) as "OPCO_VENDOR_SK" ,
                    cast("OPCO_LOCN_SK" as character varying(32)) as "OPCO_LOCN_SK" ,
                    cast("OPCO_VENDOR_OPCO_LOCN_ASSCN_TYPE_TXT" as character varying(4)) as "OPCO_VENDOR_OPCO_LOCN_ASSCN_TYPE_TXT" ,
